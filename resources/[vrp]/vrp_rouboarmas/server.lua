...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookrouboarmas = "https://discordapp.com/api/webhooks/730055442192924712/-UL9924SZjlFbDCVwVaMeXs3jc37DBhNOE2v9L8h4ixDI0GmyDdken-XCCDL7V4iMhg7"
...
local armalist = {
	...
	[2] = { ['index'] = "wbody|WEAPON_ASSAULTRIFLE_MK2", ['qtd'] = 1, ['name'] = "AK-103" },
	...
	[9] = { ['index'] = "wammo|WEAPON_ASSAULTRIFLE_MK2", ['qtd'] = 50, ['name'] = "MUNIÇÃO DE AK-103" },
