...
local carros = {
	...
	["bison"] = { price = 200000 },
	["bison2"] = { price = 180000 },
	["contender"] = { price = 1000000 },
	["rumpo3"] = { price = 1000000 },
	["boxville3"] = { price = 1000000 },
	["mule3"] = { price = 1000000 },
	["benson"] = { price = 1000000 },
	["rallytruck"] = { price = 1000000 },
	["pounder"] = { price = 1000000 },
	["terbyte"] = { price = 1000000 },
						...
						if ok then
							if parseInt(price) > 0 then
								if vRP.tryFullPayment(tuser_id,parseInt(price)) then
									...
									vRP.log("dinheiro", "Venda de Veículo", "ID: "..user_id.."\nVendeu o veiculo: "..vname.."\nPara: "..tuser_id.." \nPreço: "..vRP.format(parseInt(price)))
									local data = vRP.getSData("custom:u"..user_id.."veh_"..vname)
									local custom = json.decode(data) or ""
