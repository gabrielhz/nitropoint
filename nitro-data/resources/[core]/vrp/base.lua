...
--					deferrals.done("Entre no discord para ser liberado! https://discord.gg/8n2DBPt ID: "..user_id)
					deferrals.done("Entre no discord e será liberado automaticamente! https://discord.gg/6kRcamg")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
			else
				deferrals.done("Você foi banido da cidade. Se achou injusto entre no nosso discord https://discord.gg/6kRcamg e aguarde atendimento. Seu ID:"..user_id)
				TriggerEvent("queue:playerConnectingRemoveQueues",ids)
			end
		else
