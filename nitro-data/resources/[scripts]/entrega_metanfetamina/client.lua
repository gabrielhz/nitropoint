...
Citizen.CreateThread(function()
	while true do
		local t = 1000
		if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), 1355.9290771484,-547.56365966797,73.780937194824,true) <= 1 then
			t = 5
			DrawText3Ds(1355.9290771484,-547.56365966797,73.780937194824+0.5,"PRESSIONE ~r~E~w~ PARA COMEÇAR MISSÃO")
